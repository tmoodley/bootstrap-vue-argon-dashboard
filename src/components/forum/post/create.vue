  ...
  <div> 
    ...
    <b-form @submit="onSubmit">
        ...
        <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
          <b-form-group id="input-group-1" label="Channel" label-for="Title-1">
            <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-select v-model="post.channelId" :options="channelsChannels"></b-form-select>
            </b-input-group>
          </b-form-group>
          <b-form-group label="Subject" label-for="subjects">
            <b-form-select v-model="subjectsId" :options="subjectsObjects" v-on:change="getSelectedItem"></b-form-select>
          </b-form-group>
          <b-form-group label="Topic" label-for="topics">
            <b-form-select v-model="post.topicsId" :options="topics"></b-form-select>
          </b-form-group>
          ...
          <b-form-group label="Enter new tags separated by space" label-for="tags-remove-on-delete">
      ...
      <b-row style="margin-top:30px; float:right;">
        <b-col md="auto">
          <b-button type="submit" :disabled="post.body == '' || post.channelsId == ''">Post</b-button>
        </b-col>
      </b-row>
    </b-form> 
    <!-- Create Post /////-->
  ...
  export default {
    ...
    computed: {
      ...
      channelsChannels() {
        ...
        channelsChannels.unshift({ value: null, text: 'Please select some item' });
